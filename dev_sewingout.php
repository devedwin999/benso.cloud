...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - ORBIDX SewingOut</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    ...
                    <div class="pd-20">
                        <h4 class="text-blue h4">ORBIDX SewingOut</h4>
                    </div>
                    <div class="pb-20">
                        <table class="data-table table stripe hover nowrap dataTable no-footer dtr-inline collapsed">
                            ...
                            <tbody>
                                <?php
                                $qry = "SELECT a.*, b.order_id, b.style_id, b.part, b.color, b.variation_value, b.bundle_number ";
