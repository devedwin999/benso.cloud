...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>Benso Garmenting - Sewing Output</title>
    ...
    <div class="main-container nw-cont">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <select name="" id="FilterOpt" class="custom-select2 multiple-select" style="width: 100%" onchange="startFilter()">
                                ...
                                <?= select_dropdown('process', array('id', 'process_name'), 'process_name ASC', $_GET['ps'], ' WHERE department="5"', '`'); ?>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <script>
            function startFilter() {
                ...
                window.location.href = base_url + "view-sewingOutput.php?ps=" + FilterOpt;
            }
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="card-box mb-30">
                <div class="pd-20 text-center">
                    <h4 class="text-blue h4">Sewing Output List</h4>
                </div>
                <div class="pb-20">
                    <table class="table hover data-table-export nowrap">
                        ...
                        <tbody>
                            <?php
                                ...
                                $qry = "SELECT * FROM orbidx_sewingout";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a onclick="show_total_scanned(this)" class="" data-id="<?= $result['id']; ?>" data-from="sewing" style="color:blue; text-decoration: underline;"><?= $result['scanned_count']; ?></a></td>
