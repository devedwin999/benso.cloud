...
if (isset($_REQUEST['updateForm'])) {
    ...
    $data = array(
        'yarn_name' => filter_var($_POST['edit_yarn_name'], FILTER_SANITIZE_STRING),
        'yarn_code' => filter_var($_POST['edit_yarn_code'], FILTER_SANITIZE_STRING),
        'created_date' => date('Y-m-d H:i:s')
    );

    $qry = Update('mas_yarn', $data, " WHERE id = '" . $_REQUEST['edit_id'] . "'");

    $_SESSION['msg'] = "updated";

    header("Location:mas_yarn.php");
...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Yarn</title>
...
<body>
    ...
    <div class="main-container nw-cont">
        ...
        if ($_SESSION['msg'] == 'saved') { ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success!</strong> Yarn Added.
        ...
        <?php } else if ($_SESSION['msg'] == 'updated') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> Yarn Updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="card-box mb-30">
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                <?php
                                $qry = "SELECT * FROM mas_yarn ORDER BY id DESC";
                                        ...
                                        <td>
                                            <?php if ($sql['is_active'] == 'active') { ?>
                                                <span class="badge badge-success"
                                                    onclick="changeStatus(<?= $sql['id']; ?>,'mas_yarn','inactive')">Active</span>
                                            <?php } else { ?>
                                                <span class="badge badge-danger"
                                                    onclick="changeStatus(<?= $sql['id']; ?>,'mas_yarn','active')">Inactive</span>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myLargeModalLabel">Edit Yarn</h4>
    ...
    <script>
        $(".editmodal").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax_search.php?getYarnedit=1&id=' + id,
