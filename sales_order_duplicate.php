...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <span class="fieldrequired">BO Date :</span> 
                                    <input type="text" value="<?= $sql['order_date'] ? $sql['order_date'] : date('Y-m-d'); ?>" name="order_date" id="order_date" class="form-control date-picker" onchange="calDycnt()" required>
                            </div>
                            
                            <div class="col-md-2">
                                <span class="fieldrequired">Delivery Date :</span>
                                <input type="text" name="deliveryDate" id="deliveryDate" class="form-control date-picker" autocomplete="off" value="<?= $sql['delivery_date'] ? $sql['delivery_date'] : ''; ?>" placeholder="Delivery Date" onchange="calDycnt()" required>
                            </div>
    ...
    <script>
        function cloneBody() {
            // if ($("#size_range_id").val() == "") {
            //     message_noload('warning', 'Select Size Range!', 1000);
                
            //     return false;
            // }
            
            // var id = parseInt($("#form_id").val()) + 1;
            // var body = $('#cloneBody').clone();
            // body.children("#newheading").text('Combo ' + id);
            // body.find('#getsizeRange').attr('id', 'getsizeRange' + id);
            // body.find(".removeclone").remove();
