        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="pd-20">
                        <a class="btn btn-primary" href="customer.php" style="float: right;"><i class="fa fa-list"
                                aria-hidden="true"></i> Customer List</a>
                    </div>
                    <div class="clearfix">
                        <div class="pull-left">
                    ...
                    <form id="add-customer" method="post" autocomplete="off">
                        <div class="row">
                            <div class="col-md-4">
                                <label class="col-form-label">S.No <span class="text-danger">*</span></label>
                               <input type="number">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="state" id="state">
                                        ...
                                        <?php
                                        $qryd = mysqli_query($mysqli, "SELECT * FROM states ORDER BY state_name ASC ");
