...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Accessories Program</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    ...
                    <?php if(ACCESSORIES_PROG!=1) { action_denied(); exit; } ?>
                        ...
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                ...
                                while ($sql = mysqli_fetch_array($query)) {
                                    ...
                                    $prog = mysqli_num_rows(mysqli_query($mysqli, "SELECT * FROM sales_order_accessories_program WHERE sales_order_detalis_id=" . $sql['id']));
                                    ?>
                                    <tr>
                                        <td>
                                            <?= $x; ?>
                                        ...
                                        <td>
                                            <input type="hidden"
                                                value="uploads/so_img/<?= $sql['order_code'] . '/' . $sql['item_image']; ?>" name=""
                                                id="dsff<?= $sql['id']; ?>">
                                            <a data-img="" onclick="showimage(<?= $sql['id']; ?>)">
                                                <img src="uploads/so_img/<?= $sql['order_code'] . '/' .  $sql['item_image']; ?>" alt="Image"
                                                    width="50"></a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <?php if(ACCESSORIES_PROG_ADD==1) { ?>
                                                        <a class="dropdown-item" href="add-accessProg.php?id=<?= $sql['id'] ?>"><i class="icon-copy fa fa-plus"></i> Create Program</a>
                                                    <?php } if(ACCESSORIES_PROG_PRINT==1) {  
                                                            if ($prog>0) { ?>
