...
if (isset($_REQUEST['updateForm'])) {
    ...
    $data = array(
        'color_name' => filter_var($_POST['edit_color_name'], FILTER_SANITIZE_STRING),
        'created_date' => date('Y-m-d H:i:s')
    );

    $qry = Update('color', $data, " WHERE id = '" . $_REQUEST['edit_color_id'] . "'");
...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Colors</title>
...
<body>
    ...
    <div class="main-container nw-cont">
        ...
        if ($_SESSION['msg'] == 'saved') { ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success!</strong> Color Added.
        ...
        <?php } else if ($_SESSION['msg'] == 'updated') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> Color Updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                <?php
                                $qry = "SELECT * FROM color ORDER BY id DESC";
                                        ...
                                        <td>
                                            <?php if ($sql['is_active'] == 'active') { ?>
                                                <span class="badge badge-success"
                                                    onclick="changeStatus(<?= $sql['id']; ?>,'color','inactive')">Active</span>
                                            <?php } else { ?>
                                                <span class="badge badge-danger"
                                                    onclick="changeStatus(<?= $sql['id']; ?>,'color','active')">Inactive</span>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    <form id="delete-company" method="post" autocomplete="off">
                                                        ...
                                                        <a class="dropdown-item"
                                                            onclick="delete_data(<?= $sql['id']; ?>, 'color')"><i
                ...
                <!-- <div class="modal fade" id="color-add-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                    aria-hidden="true">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="color_name"
                                                    id="color_name" placeholder="Color Name" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(".editmodal").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax_search.php?getcoloredit=1&id=' + id,
