...
//     header("Location:selection_type.php");
...
if (isset($_REQUEST['updateForm'])) {
    ...
    $qry = Update('selection_type', $data, " WHERE id = '" . $_REQUEST['edit_type_id'] . "'");
...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Selection Type</title>
...
<body>
    ...
    <div class="main-container nw-cont">
        ...
        if ($_SESSION['msg'] == 'saved') { ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success!</strong> Selection Type Added.
        ...
        <?php } else if ($_SESSION['msg'] == 'updated') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> Selection Type Updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
                ...
                <div class="card-box mb-30">
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                <?php
                                $qry = "SELECT * FROM selection_type ORDER BY id DESC";
                                        ...
                                        <td>
                                            <?php if ($sql['is_active'] == 'active') { ?>
                                                <span class="badge badge-success"
                                                    onclick="changeStatus(<?= $sql['id']; ?>,'selection_type','inactive')">Active</span>
                                            <?php } else { ?>
                                                <span class="badge badge-danger"
                                                    onclick="changeStatus(<?= $sql['id']; ?>,'selection_type','active')">Inactive</span>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <?php if(MAS_SEL_TYPE_EDIT==1) { ?>
                                                        <a class="dropdown-item editmodal" data-id="<?= $sql['id']; ?>" href="javascript:void(0)"><i class="dw dw-edit2"></i> Edit</a>
                                                    <?php } if(MAS_SEL_TYPE_DELETE==1) { ?>
                                                        <a class="dropdown-item" onclick="delete_data(<?= $sql['id']; ?>, 'selection_type')"><i class="dw dw-delete-3"></i> Delete</a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myLargeModalLabel">Edit Type</h4>
            ...
            <?php
            $modals = ["selection-type-add-modal"];
            include('modals.php');
    ...
    <script>
        ...
        $(".showmodal").click(function () {
            $("#selection-type-add-modal").modal('show');
        })
    </script>
    ...
    <script>
        $(".editmodal").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax_search.php?getselection_typeedit=1&id=' + id,
