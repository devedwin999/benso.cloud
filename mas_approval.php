...
if (isset($_REQUEST['updateForm'])) {
    ...
    $data = array(
        ...
        'daily_followup' => $_REQUEST['edit_daily_followup'],
        'end_followup' => $_REQUEST['edit_end_followup'],
        'daily_followup_duration' => $_REQUEST['edit_daily_followup_duration'],
        'end_followup_duration' => $_REQUEST['edit_end_followup_duration'],
...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO - Approval Master</title>
                            ...
                            <tbody>
                                ...
                                while ($sql = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $sql['daily_followup']; ?>&nbsp;<?= $sql['daily_followup_duration']; ?></td>
                                        <td><?= $sql['end_followup']; ?>&nbsp;<?= $sql['end_followup_duration']; ?></td>
                                        <td>
                                            <div class="dropdown">
