...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Checking Piece Scanning
        <?= $comp; ?>
    </title>
...
<!--style="border: 1px solid #e9e5e5;border-radius: .25rem;box-shadow: 0 0 28px rgb(0 0 0 / 5%);padding: 25px;background: rgb(0 0 0 / 2%);"-->
                        <div class="row">
                            <div class="col-md-8" >
                                <div class="row">
                                    <?php
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select2 form-control w-100" <?= $_GET['id'] ? 'disabled' : 'name="order_id" id="order_id"'; ?>>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <select name="scanning_for" id="scanning_for" class="custom-select2 form-control" style="width:100%">
                                                    ...
                                                    <option value="Rework" <?= ($sql['scanning_for'] == 'Rework') ? 'selected' : ''; ?>>Rework Pcs</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <select name="pieces_type" id="pieces_type" onchange="pieces_typewe()" class="custom-select2 form-control" style="width:100%">
                                                <?= select_dropdown('mas_checking', array('id', 'checking_name'), 'id ASC', '', '', '`'); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    if($sql['scanning_using'] == 'Device') { ?>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function onScanSuccess(qrCodeMessage) {
                                                ...
                                                $.ajax({
                                                    type: 'POST',
                                                    url: 'ajax_search.php?validateQR_piece=1&qr=' + qrCodeMessage +'&type=checking_list' + '&order_id=' + order_id,
                            ...
                            <div class="col-md-4" style="border: 1px solid #e9e5e5;border-radius: .25rem;box-shadow: 0 0 28px rgb(0 0 0 / 5%);padding: 25px;background: rgb(0 0 0 / 2%);">
                                <div class="row" style="padding-top: 5%;">
                                    
                                        <?php
                                            $flkf = mysqli_query($mysqli, "SELECT * FROM mas_checking ORDER BY id ASC");
                                            while($res = mysqli_fetch_array($flkf)) {
                                        ?>
                                        <div class="col-md-4 col-6 text-center" style="padding:5px">
                                            <a class="btn" style="width:100%;color: #fff !important;background-color: <?= $res['checking_color']; ?>;border-color: <?= $res['checking_color']; ?>;border-radius: 0.25rem 0.25rem 0rem 0rem;"><?= $res['checking_name']; ?></a>
                                            
                                            <a class="btn ch_typ<?= $res['id']; ?>" style="width:100%;color: <?= $res['checking_color']; ?>;border-color: <?= $res['checking_color']; ?>;border-radius: 0rem 0rem 0.25rem 0.25rem;">0</a>
                                        </div>
                                        <?php
                                            }
                                        ?>
                        ...
                        <script>
                            function pieces_typewe() {
                                ...
                                //     if(a=='ch_good_pcs') { var mlk = 'Good'; }
                                //     else if(a=='ch_rework_pcs') { var mlk = 'Rework'; }
                                //     else if(a=='ch_reject_pcs') { var mlk = 'Rejection'; }
                                    
                                // message_noload('info', 'Scanning bundles are considered '+ mlk +' Pieces!', 2000);
                        ...
                        <script type="text/javascript">
                            ...
                            function onScanSuccess(qrCodeMessage) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: 'ajax_search.php?validateQR_piece=1&qr=' + qrCodeMessage +'&type=checking_list',
                                    success: function (msg) {
                                        // return false;
                                        var json = $.parseJSON(msg);
                        ...
                        <!--        </div>-->
                                ...
                                <div class="col-md-12 d-none" style="text-align:center">Scanned Bundle Count : <span id="scanedCnt"><?= ($sql['boundle_id'] != "") ? count(explode(',', $sql['boundle_id'])) : '0'; ?></span></div>
                            </div>
                        </div>
                        ...
                        <div class=" row">
                            <div class="col-md-12">
                                <div class="form-group" style="text-align: center;">
                                    ...
                                    <a class="btn btn-outline-secondary" href="checking-list.php">Go Back</a>
    ...
    <script>
        $("#partNum").change(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax_search.php?getbundleNoProcess=1&prtno=' + prtno + '&ordno=' + ordno + '&stylno=' + stylno +'&type=checking_list',
                success: function (msg) {
    ...
    <script>
        function removeChecking(pid, bid) {
            // alert(pid+ '--' +bid);
            
            var sTyp = 'piece';
            $.ajax({
                type: 'POST',
                url: 'ajax_action.php?removeChecking=1&pid='+ pid +'&bid='+ bid,
                
                success: function (msg) {
                    var json = $.parseJSON(msg);
                    
                    if(json.res==0) {
                        message_noload('success', 'Deleted', 1500);
                        savedBundles(pid);
                    }
                }
            });
    ...
    <script>
        ...
        function savedBundles(id)
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax_search.php?checked_pieces_details=1&id='+ id +'&sTyp='+ sTyp,
                
                success: function (res) {
                    var json = $.parseJSON(res);
                    console.log(json.ch_typ);
                    ...
                    // ).then(
                    //     function () {
                            $("#scanedCnt").text(json.cntt);
                            $("#tableBody").html(json.tbl_bdy);
                        // })
                }
            });
        }
    ...
    <script>
        ...
        function saveEdit(id)
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax_action.php?update_qtty_check=1&id=' + id + '&good=' + good + '&reject=' + reject + '&rework=' + rework,
                success: function (msg) {
