...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - In-house Received List</title>
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                ...
                                $qry .= " WHERE a.input_type= 'Unit' AND a.assigned_emp='" . $logUnit . "' AND a.type='process_outward' AND a.is_inhouse = 'approved' ORDER BY a.id DESC ";
                                ...
                                while ($sql = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $sql['process_id'] ? process_name($sql['process_id']) : '-'; ?></td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <?php if ($sql['is_inhouse'] != 'approved') {
                                                        if(INHOUSE_RECEIVE==1) {
                                                    ?>
                                                    ...
                                                    <?php } } else if(isset($_GET['dc'])){ if(INHOUSE_DC_CREATE==1) { ?>
                                                        <a class="dropdown-item" onclick="completed_mark(<?= $sql['id']; ?>)"><i class="icon-copy fa fa-list-alt" aria-hidden="true"></i>Create to DC</a>
				                                    <?php } } else { if(INHOUSE_DAILY_PROCESS==1) { ?>
                                                        <a class="dropdown-item" data-id="<?= $sql['id']; ?>" href="in_house_daily_update.php?id=<?= $sql['id'] ?>&wh=list"><i class="dw dw-edit2"></i>Update Daily Process</a>
				                                    <?php } if(INHOUSE_VIEW==1) { ?>
