...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Checking List</title>
    ...
    <div class="main-container nw-cont">
            ...
            <div class="card-box mb-30">
                ...
                <div class="pd-20">
                    <?php if(CHECKING_ADD==1) { ?>
                        <a class="d-none btn btn-outline-primary" href="checking-new.php" style="float: right;"><i
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <select name="" id="FilterOpt" class="custom-select2 multiple-select" style="width: 100%" onchange="startFilter()">
                                ...
                                <?= select_dropdown('process', array('id', 'process_name'), 'process_name ASC', $_GET['ps'], ' WHERE department="6"', '`'); ?>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <script>
            function startFilter() {
                ...
                window.location.href = base_url + "checking-list.php?ps=" + FilterOpt;
            }
                ...
                <div class="pb-20">
                    <table class="table hover multiple-select-row data-table-export nowrap">
                        ...
                        <tbody>
                            <?php
                                $i = 1;
                                $qry = "SELECT * FROM orbidx_checking";
