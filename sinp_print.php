...
<body>
    ...
    <?php
    $a = "SELECT a.*,b.company_name, b.address1, c.employee_name ";
    $a .= " FROM processing_list a ";
    $a .= " LEFT JOIN company b ON a.production_unit=b.id ";
    $a .= " LEFT JOIN employee_detail c ON a.assigned_emp=c.id ";
    ...
    <div id="divToPrint">
        <table style="font-family: Calibri;border: 1px solid grey;padding: 10px;">
            <tr>
                <td colspan="8">
                    <center><b>Sewing Input</center></b>
                </td>
            </tr>
            <tr>
                <td colspan="8">
                    <table
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid gray;" colspan="4">
                                <table>
                                    <tr><td style="font-weight:bold"> Line : </td></tr>
                                    <tr><td><?= line_name($sql['assigned_emp']); ?></td></tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
