...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Budget</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    ...
                    <?php page_spinner(); if(BUDGET!=1) { action_denied(); exit; } ?>
                    
                    <div class="pd-20">
                        <h4 class="text-blue h4">Budget List</h4>
                    </div>
                    <div class="pb-20" style="overflow-y: scroll;">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    <a class="dropdown-item" href="cmt-print.php?id=<?= $sql['id']; ?>&ret=cmt_budget"><i class="icon-copy fa fa-print"></i> CMT Print </a>
                                                        <?php if(BUDGET_ADD ==1 || BUDGET_EDIT ==1) { ?>
                                                            <a class="dropdown-item" href="add-budget.php?id=<?= $sql['id']; ?>&ret=cmt_budget"><i class="icon-copy fa fa-pencil-square-o"></i> Add & Edit Budget </a>
                                                        <?php } if(BUDGET_VIEW ==1) {
                                                            print '<a class="dropdown-item" href="view-budget.php?id=' . $sql['id'] . '"><i class="icon-copy fa fa-eye" aria-hidden="true"></i>View</a>';
                                                        }
                                                        ?>
