...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Production Stock Report</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <?php page_spinner(); if(RP_PROD_STOCK!=1) { action_denied(); exit; } ?>
                    <div class="pd-20">
                        <div class="row">
                            <div class="col-md-12 d-flex" style="justify-content: space-between ;">
                                <h5>Production Stock Report</h5>
                ...
                <div class="card-box mb-30" id="divToPrint">
                    <div class="pd-20" style="text-align:center">
                        <h4 class="text-blue h4">Production Stock Report</h4>
                    </div>
                    <div class="pb-20"  style="overflow-y:auto;">
                        <table class="table table-striped table-bordered hover">                           
                            ...
                            <tbody id="response">
                                <tr><td colspan="15" class="text-center">-- Nothing Found</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
...
<script>
    $(".filtttr_search").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'ajax_reports.php?prod_stock_report=1',
            data: data,
