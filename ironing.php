...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Ironing List</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <?php if(IRONING!=1) { action_denied(); exit; } ?>
                    <div class="pd-20">
                        <?php if(IRONING_ADD==1) { ?>
                            <a class="btn btn-outline-primary" href="ironing-add.php" style="float: right;"><i
                                    class="fa fa-plus" aria-hidden="true"></i> Add New</a>
                        <?php } ?>
                        <h4 class="text-blue h4">Ironing List</h4>
                    </div>
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                <?php
                                $qry = "SELECT a.*, b.sales_order_id, b.sales_order_detail_id, b.combo_id, b.color_id, b.part_id FROM ironing a LEFT JOIN sod_part b ON a.sod_part=b.id ORDER BY a.id DESC ";
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <?php if(IRONING_EDIT==1) { ?>
                                                        <a class="dropdown-item" href="ironing-add.php?id=<?= $sql['id'] ?>&type=view"><i class="dw dw-view"></i> View</a> 
                                                        <a class="dropdown-item" href="ironing-add.php?id=<?= $sql['id'] ?>"><i class="dw dw-edit2"></i> Edit</a> 
                                                    <?php } if(IRONING_VIEW==1) { ?>
                                                        <a class="dropdown-item" href="ironing-add.php?id=<?= $sql['id']; ?>&typ=<?= ('view') ?>"><i class="dw dw-eye"></i> View</a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </td>
