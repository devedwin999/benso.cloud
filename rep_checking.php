...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Checking Report</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <?php if(RP_CHECKING!=1) { action_denied(); exit; } ?>
                    <div class="pd-20">
                        <div class="row">
                ...
                <div class="card-box mb-30" id="divToPrint">
                    <div class="pd-20" style="text-align:center">
                        <h4 class="text-blue h4">Checking Report</h4>
                    </div>
                    <div class="pb-20">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                while ($sql = mysqli_fetch_array($query)) {
                                    ...
                                    $ch_comp = mysqli_fetch_array(mysqli_query($mysqli, "SELECT sum(a.ch_good_pcs) as ch_good_pcs, sum(a.ch_reject_pcs) as ch_reject_pcs FROM bundle_details a LEFT JOIN cutting_barcode b ON a.cutting_barcode_id=b.id 
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $ch_comp['ch_reject_pcs'] ? $ch_comp['ch_reject_pcs'] : 0; ?></td>
                                        <td><?= $ch_comp['ch_good_pcs'] ? $ch_comp['ch_good_pcs'] : 0; ?></td>
                                    </tr> 
                                    <?php $x++;
