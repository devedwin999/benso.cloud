...
if (isset($_POST['SaveBtn'])) {
    ...
    for ($m = 0; $m < count($_POST['piece_id']); $m++) {
        $upd = mysqli_query($mysqli, "UPDATE bundle_piece_details SET sewing_input='yes' WHERE id='" . $_POST['piece_id'][$m] . "'");
    }

    if (isset($_POST['SaveBtn']) && isset($_GET['id'])) {
        $qry = Update(' sewing_input', $data, " WHERE id = '" . $_GET['id'] . "'");
...
if (isset($_GET['id'])) {
    ...
    $sql = mysqli_fetch_array(mysqli_query($mysqli, "SELECT * FROM sewing_input WHERE id=" . $id));
} else {
    $comp = 'Add Processing';
    $id = '';
}
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="pd-20">
                        <a class="btn btn-outline-primary" href="View-sewingInput.php" style="float: right;"><i
                                class="fa fa-list" aria-hidden="true"></i> Sewing Input List</a>
                    </div>
                    <div class="clearfix">
                        <div class="pull-left">
                    ...
                    <form id="add-process" method="post" autocomplete="off">
                        <div class="row">
                            ...
                            if (isset($_GET['id'])) {
                                ...
                                $qryz = mysqli_query($mysqli, "SELECT * FROM sewing_input WHERE entry_num LIKE '%SI-%' ORDER BY id DESC");
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <input type="date" name="entry_num" class="form-control" value="<?= $code; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <select name="" id="" class="custom-select2 form-control" style="width:100%">
                                        <?= select_dropdown('employee_detail', array('id', 'employee_name'), 'employee_name ASC', '', '', ''); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <select name="pieceQrNum" id="pieceQrNum" class="custom-select2 form-control"
                                        style="width:100%">
                                        <?= select_dropdown('bundle_piece_details', array('id', 'piece_qr'), 'piece_qr ASC', '', 'WHERE in_proseccing="yes" AND is_inwarded="yes" AND sewing_input IS NULL', ''); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" style="overflow-y: scroll;">
                                ...
                                <table class="table">
                                    ...
                                    <tbody id="tableBody">
                                        <?php
                                        if (isset($_GET['id'])) {
                                            $ftch = mysqli_fetch_array(mysqli_query($mysqli, "SELECT * FROM sewing_input WHERE id='" . $_GET["id"] . "'"));
