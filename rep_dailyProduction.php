...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Daily Production Report</title>
                    ...
                    <div class="pb-20" style="overflow-y: auto;">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody id="report_tbody">
                                <tr>
                                    <td class="text-center" colspan="24">-- Apply Filter to get results! --</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<script>
    $(".filtttr_search").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'ajax_reports.php?production_register=1',
            data: data,
            success: function(msg) {
                var j = $.parseJSON(msg);
                $("#report_tbody").html(j.row_count > 0 ? j.table_tr : '<tr><td class="text-center" colspan="24">-- Nothing Found --</td></tr>');
