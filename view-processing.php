...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Processing</title>
                ...
                <div class="card-box mb-30">
                    ...
                    <div class="pd-20">
                        <?php if(P_OUTWARD_ADD==1) { ?>
                            <a class="btn btn-outline-primary" href="add-processing.php" style="float: right;"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
                        <?php } ?>
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                ...
                                $qry = "SELECT a.* FROM processing_list a WHERE a.type='process_outward' $wh ORDER BY a.id DESC";
                                ...
                                while ($sql = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= process_name($sql['process_id']); ?></td>
                                        <td><?= $typ ? $typ : '-'; ?></td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    <a class="dropdown-item" href="pow_print.php?id=<?= $sql['id'] ?>" target="_blank"> <i class="icon-copy fa fa-print" aria-hidden="true"></i> Print Invoive</a>
                                                    <?php if(P_OUTWARD_EDIT==1) { ?>
                                                        <a class="dropdown-item" data-id="<?= $sql['id']; ?>" href="add-processing.php?id=<?= $sql['id'] ?>"><i class="dw dw-edit2"></i> Edit</a>
