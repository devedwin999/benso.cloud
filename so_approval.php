...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>BENSO GARMENTING - Sales Order Approval</title>
...
<body>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    ...
                    <div class="pd-20">
                        <h4 class="text-blue h4">SO Approval Waiting List
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                <?php
                                $qry = "SELECT a.*, b.brand_name FROM sales_order a LEFT JOIN brand b ON a.brand = b.id WHERE a.is_approved IS NULL ORDER BY a.id DESC";
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    if ($sql['is_approved'] != 'approved') {
                                                        if(SO_APPROVAL==1) {
                                                    ?>
                                                            <a class="dropdown-item" onclick="is_approved_id(<?= $sql['id']; ?>)"><i class="icon-copy fa fa-list-alt" aria-hidden="true"></i> SO Approval </a>
                                                        <?php } if(SALES_ORDER_DELETE==1) { ?>
                                                            <!--<a class="dropdown-item" onclick="delete_data(<?= $sql['id']; ?>)"><i class="dw dw-delete-3"></i> Delete</a>-->
                                                        <?php } } else { ?>
                                                            <!--<a class="dropdown-item" href="so_print.php?id=<?= $sql['id'] ?>" target="_blank">-->
                                                            <!--    <i class="icon-copy fa fa-print" aria-hidden="true"></i> Print Invoive</a>-->
                                                        <?php
    ...
    <script>
        ...
        $(".soapprove").click(function () {
            ...
            var data = 'id=' + id + '&is_approved=' + is_approved;

            $.ajax({
                type: 'POST',
                url: 'ajax_action.php?approve_so',
                data: data,
