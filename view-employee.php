...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>BENSO - View Employee</title>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            <div class="profile-photo">
                                <?= viewImage($sql['employee_photo'], 200); ?>
                            </div>
                            <h5 class="text-center h5 mb-0"><?= $sql['employee_name']; ?></h5>
                            <p class="text-center text-muted font-14"><?= designation_name($sql['designation']); ?></p>
                            <div class="profile-info">
                                <h5 class="mb-20 h5 text-blue">Contact Information</h5>
                                <ul>
                                    <li><span>Email Address:</span><?= $sql['email']; ?></li>
                                    <li><span>Phone Number:</span><?= $sql['mobile']; ?></li>
                                    <li><span>Address:</span><?= employee_address($sql['id']); ?></li>
                                </ul>
                            </div>
                            ...
                            <div class="profile-tab height-100-p">
                                <div class="tab height-100-p">
                                    <ul class="nav nav-tabs customtab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#setting" role="tab">Login Details</a>
                                        </li>
                                    </ul>
                                                ...
                                                <form>
                                                    <ul class="profile-edit-list row">
                                                        <li class="weight-500 col-md-6">
                                                            <h4 class="text-blue h5 mb-20">User Name: <span class="u text-danger"><?= $sql['username']; ?></span> </h4>
                                                            <div class="form-group">
                                                                <label>User Name</label>
                                                                <input class="form-control form-control-lg" id="user_name" type="text" placeholder="User Name">
                                                            </div>
                                                        </li>
                                                        <li class="weight-500 col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <a class="btn btn-outline-primary"><i class="fa-save fa"></i> Update</a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </form>
